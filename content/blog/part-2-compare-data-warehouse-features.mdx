...
<table class="border-collapse w-full border border-slate-400 dark:border-slate-500 bg-white dark:bg-slate-800 text-sm shadow-sm">
  ...
  <tbody>
    ...
    <tr>
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">**Data Sharing Capabilities**</td>
      ...
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400"></td>
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">[Delta Sharing](https://www.databricks.com/product/delta-sharing)</td>
            <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400"></td>
    ...
    <tr>
      ...
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">Containers, Pandas, Python / Javascript5️⃣</td>
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">Containers, Spark via Dataproc2️⃣</td>
...
* If you're on AWS, using Glue will give you the option to use both Athena, Redshift Serverless, Snowflake, and BigQuery. 
Athena is the easiest to start with on AWS and you can switch over Redshift Serverless over time.
* If you're on GCP, BigQuery is probably the best option for you.
* If you're cross cloud:
	* Snowflake is the best option for you if you have SQL-familiar people like analysts and analytics engineers.
	* Databricks is the best option for you if you have data engineers and data scientists, focusing on ML. 
	* If you're expanding to AWS from GCP, BigQuery is still worth investing in.