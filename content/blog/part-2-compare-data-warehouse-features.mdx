...
isPublished: true
tags: ['meta']
description: Comparing features of Snowflake, BigQuery, Redshift Serverless and Databricks, AWS Athena
toc: false
...
<table class="border-collapse w-full border border-slate-400 dark:border-slate-500 bg-white dark:bg-slate-800 text-sm shadow-sm">
  <thead class="bg-slate-50 dark:bg-slate-700">
    <tr>
      ...
      <th class="border border-slate-300 dark:border-slate-600 font-semibold p-4 text-slate-900 dark:text-slate-200 text-left">[Snowflake](/blog/part-2-compare-data-warehouse-features#best-overall-snowflake-%EF%B8%8F)</th>
      <th class="border border-slate-300 dark:border-slate-600 font-semibold p-4 text-slate-900 dark:text-slate-200 text-left">[AWS Redshift Serverless](/blog/part-2-compare-data-warehouse-features#cool-again-redshift-serverless)</th>
      <th class="border border-slate-300 dark:border-slate-600 font-semibold p-4 text-slate-900 dark:text-slate-200 text-left">[Google BigQuery](/blog/part-2-compare-data-warehouse-features#hidden-gem-bigquery)</th>
      <th class="border border-slate-300 dark:border-slate-600 font-semibold p-4 text-slate-900 dark:text-slate-200 text-left">[Databricks](/blog/part-2-compare-data-warehouse-features#most-flexible-databricks)</th>
      <th class="border border-slate-300 dark:border-slate-600 font-semibold p-4 text-slate-900 dark:text-slate-200 text-left">[AWS Athena](/blog/part-2-compare-data-warehouse-features#easiest-to-start-with-aws-athena)</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      ...
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">[BI Engine](https://cloud.google.com/bigquery/docs/bi-engine-intro), [BigTable](https://cloud.google.com/bigquery/docs/export-to-bigtable), [Spanner](https://cloud.google.com/bigquery/docs/export-to-spanner), [Pub/Sub](https://cloud.google.com/bigquery/docs/export-to-pubsub)</td>
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">-</td>
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">-</td>
    </tr>
    <tr>
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">**Scheduling**</td>
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">[Tasks](https://docs.snowflake.com/en/user-guide/tasks-intro) 5️⃣</td>
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">-</td>
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">[Scheduled queries](https://cloud.google.com/bigquery/docs/scheduling-queries), Workflows 4️⃣</td>
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">[Workflows](https://www.databricks.com/product/workflows) 5️⃣</td>
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">-</td>
    </tr>
    <tr>
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">**Sharing Capabilities**</td>
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">Data ([Secure share](https://docs.snowflake.com/en/user-guide/data-sharing-intro)), Code ([Framework](https://docs.snowflake.com/en/developer-guide/native-apps/native-apps-about)) 5️⃣</td>
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">[AWS Clean Rooms](https://eu-west-2.console.aws.amazon.com/cleanrooms/home?region=eu-west-2#/)  4️⃣</td>
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">[Analytics Hub](https://cloud.google.com/analytics-hub?hl=en), VMs 4️⃣</td>
    ...
    <tr>
      ...
      <td class="border border-slate-300 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">[1.5K listing](https://console.cloud.google.com/marketplace?hl=en) 3️⃣</td>
...
<table class="border-collapse w-full border border-slate-400 dark:border-slate-500 bg-white dark:bg-slate-800 text-sm shadow-sm">
  <thead class="bg-slate-50 dark:bg-slate-700">
    <tr>
      <th class="border border-slate-300 dark:border-slate-600 font-semibold p-4 text-slate-900 dark:text-slate-200 text-left"></th>
      <th class="border border-slate-300 dark:border-slate-600 font-semibold p-4 text-slate-900 dark:text-slate-200 text-left">[Snowflake](/blog/part-2-compare-data-warehouse-features#best-overall-snowflake-%EF%B8%8F)</th>
      <th class="border border-slate-300 dark:border-slate-600 font-semibold p-4 text-slate-900 dark:text-slate-200 text-left">[AWS Redshift (S)](/blog/part-2-compare-data-warehouse-features#cool-again-redshift-serverless)</th>
      <th class="border border-slate-300 dark:border-slate-600 font-semibold p-4 text-slate-900 dark:text-slate-200 text-left">[Google BigQuery](/blog/part-2-compare-data-warehouse-features#hidden-gem-bigquery)</th>
      <th class="border border-slate-300 dark:border-slate-600 font-semibold p-4 text-slate-900 dark:text-slate-200 text-left">[Databricks](/blog/part-2-compare-data-warehouse-features#most-flexible-databricks)</th>
      <th class="border border-slate-300 dark:border-slate-600 font-semibold p-4 text-slate-900 dark:text-slate-200 text-left">[AWS Athena](/blog/part-2-compare-data-warehouse-features#easiest-to-start-with-aws-athena)</th>
    </tr>
...
* Snowflake [Native Application Framework](https://docs.snowflake.com/en/developer-guide/native-apps/native-apps-about) provides a first-class data application experience, sharing data and code with your partner. It's superior to AWS and GCP Marketplace.
...
* BigQuery [run Spark procedures via Dataproc](https://cloud.google.com/bigquery/docs/spark-procedures), managed Spark cluster offering from GCP.
...
Their BYOC approach (Bring your own cloud) is a good idea but it's not as easy as it sounds. You need to have a good understanding of Spark and Databricks to use them effectively.
...
Years ago when Redshift came out in 2012, it revolutionised the data warehouse ecosystem because it was a huge boost from Hadoop to Redshift. However; over the last 10 years, its competitor Snowflake has been eating Redshift's lunch. 
Even Redshift salespeople were selling Snowflake to their customers, probably because it's clearly a better product and AWS makes money from Snowflake anyway for compute. 
...
AWS Athena is using AWS Glue as a Data Catalog and it's a serverless data warehouse on the AWS data and Iceberg tables.
It can create tables but it's simpler than its competitors. That makes it a natural choice if you're on AWS and need something quick and easy to use.
