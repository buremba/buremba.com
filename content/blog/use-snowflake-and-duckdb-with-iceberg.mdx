...
If you're already using Databricks / Google Dataproc / AWS EMR, you can use [Spark's Iceberg integration](https://iceberg.apache.org/docs/1.5.1/spark-getting-started/#reading) to write Iceberg tables without using Snowflake's compute. Later, you can use Snowflake's [object storage](https://docs.snowflake.com/en/user-guide/tables-iceberg-configure-catalog-integration-object-storage) catalog to create Iceberg tables.
...
If your team is building a data application, and serving the data via a BI tool, you have a [variety of options](https://iceberg.apache.org/vendors/)([2](https://cloud.google.com/bigquery/docs/iceberg-tables)) to use any other tool that supports Iceberg. 
