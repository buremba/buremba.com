...
One of the main supporters [MotherDuck](https://motherduck.com/) offers cloud version that supports [hybrid processing](https://motherduck.com/blog/announcing-motherduck-duckdb-in-the-cloud/).
...
**Apache DataFusion** benefits from the broad and diverse community of the [Apache Software Foundation](https://www.apache.org/). Contributions from various organizations and individuals drive continuous improvement and innovation. At the time being, there are [11 PMC members](https://people.apache.org/phonebook.html?pmc=datafusion) and they include NVIDIA, Apple. And startups like Posit, Synnada,

<a href="https://next.ossinsight.io/widgets/official/analyze-repo-stars-history?repo_id=358917318" target="_blank" align="center">
    <img alt="Star History of duckdb/duckdb" src="https://next.ossinsight.io/widgets/official/analyze-repo-stars-history/thumbnail.png?repo_id=358917318&image_size=auto&color_scheme=light" width="721" height="auto" />
</a>
...
Developed in Rust, it provides safety and performance benefits.
...
![My own Image](/images/blog/duckdb/cold_run.png)
...
![My own Image](/images/blog/duckdb/hot_run.png)
![My own Image](https://app.plusdocs.com/emrekabakci-s53q/snapshot/clwe7uxv4006ljw082w33w217)
...
* Duckdb has a huge advantage being installed in many data people's laptops, by 10x [1.3k installs last month as of today in brew](https://formulae.brew.sh/formula/duckdb) compared to DataFusion, which is around [100 installs last month](https://formulae.brew.sh/formula/duckdb). I assume NVIDIA, Apple and Alibaba has much more installs in their clusters but I'm not sure about their production usage.
